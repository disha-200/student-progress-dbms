...
<body style="background-image: url(login_page_bg.png); background-size: cover; ">
    ...
    <form method="POST" action="update_password.php">
            ...
            <label style=" color: darkslateblue ; font-weight: 900">UPDATE STUDENT PASSWORD :- </label>&nbsp;&nbsp; 
            <label style="color: darkslateblue ; font-weight: 900">NEW PASSWORD :</label>

            <input name="password" type="password" placeholder="Enter" title="ID" class="style" >&nbsp;&nbsp;
...
$query = "UPDATE student set student_password='$password' WHERE student_id='$id' ";
